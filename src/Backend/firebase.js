...
import { getFirestore, doc, setDoc, collection, addDoc, getDocs, query, where, writeBatch, updateDoc, arrayUnion } from "firebase/firestore";
...
export { auth, db, createUserWithEmailAndPassword, setDoc, doc, collection, addDoc, getDocs, query, where, writeBatch, updateDoc, arrayUnion };